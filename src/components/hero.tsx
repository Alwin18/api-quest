...
const Hero = () => {
  return (
    <>
      <div className="bg-slate-200 h-screen px-10 py-28 items-center w-full flex flex-col justify-center">
        <div className="border-2 h-[54px] w-[240px] border-orange-500 flex items-center rounded-2xl gap-2 px-4 text-orange-500">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="text-md font-bold">#3 Iqbal ASu</div>
          </div>
        </div>
        ...
        <div className="flex justify-between mt-4 gap-10">
            ...
            <Link to={"/teams"}>
            <button className="text-blue-500 px-8 py-2 rounded-lg border border-blue-500">Launch Web APP</button>
            </Link>
        </div>
